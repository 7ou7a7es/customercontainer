...
public class CustomerController {
    ...
    public String processFindForm(Customer customer, BindingResult result, Map<String, Object> model) {
        ...
        Collection<Customer> results = this.customerService.findCustomerByLastName(customer.getLastName());
        if (results.isEmpty()) {
            // no customers found
    ...
    public ModelAndView showCustomer(@PathVariable("customerId") int customerId) {
        ...
        mav.addObject(this.customerService.findCustomerById(customerId));
        return mav;
    }
